/datum/faction/idris_incorporated
	...
	description = {"<p>
Самый большой межзвездный банковский конгломерат, 'Idris Incorporated'
оперируется загадочной семьёй Идрис. Влияние 'Idris Incorporated' может быть прослежено во всех уголках
человеческого пространства с их финансированием каждого типа бизнеса и предприятия. Их работа связанна с
повышенным риском и имеет оплату, подкрепленную Силами Возврата Идрис, IPC модели Shell посланы для
получения оплаты от безответственных заёмщиков. В последние годы, они начали диверсификацию в область
сервисных индустрий.
	\
	</p>"}
